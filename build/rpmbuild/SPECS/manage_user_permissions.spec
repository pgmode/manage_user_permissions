...
install -m 644 ./%{name}-%{version}/manage_user_permissions--1.0.sql %{buildroot}/usr/pgsql-16/share/extension/
install -m 644 ./%{name}-%{version}/manage_user_permissions.control %{buildroot}/usr/pgsql-16/share/extension/

%files
/usr/pgsql-16/share/extension/manage_user_permissions--1.0.sql
